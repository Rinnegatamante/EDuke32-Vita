...
static int initImeDialog(char *title, const char *initial_text, int max_text_length, int type, int option) {
...
static int isImeDialogRunning() {
	return ime_dialog_running;
}

static uint16_t *getImeDialogInputTextUTF16() {
	return ime_input_text_utf16;
}

static uint8_t *getImeDialogInputTextUTF8() {
